<div class="intro-slider slide-animate owl-carousel owl-theme show-nav-hover nav-inside nav-big"
        ...
        <div class="banner intro-slide1" style="background: url({{asset('theme/assets/images/demoes/demo42/slider/slide1.jpg')}}) rgb(255, 255, 255); min-height: 530px; background-position: right center; background-repeat: no-repeat;">
            <div class="container">
                <div class="wrapper">
                ...
                <div class="row h-100">
                    <div class="col-md-5 banner-media appear-animate d-none d-md-block"
                        ...
                        <img src="{{asset('theme/assets/images/demoes/demo42/banner1.jpg')}}" width="426" height="426"
                            alt="banner" />
                        ...
                        <div class="banner-content banner-layer-middle">
                            <div class=" appear-animate" data-animation-name="fadeInLeftShorter"
                                ...
                                <div class="brand-logo px-3 mb-1">
                                    <img src="{{asset('theme/assets/images/demoes/demo42/new_brand3_light.png')}}" width="140"
                                        height="60" alt="brand" />
                                </div>
            ...
            <div class="container">
                ...
                <div class="row h-100">
                    ...
                    <div class="col-md-5 banner-media appear-animate d-none d-md-block "
                        ...
                        <img src="{{asset('theme/assets/images/demoes/demo42/banner2.jpg')}}" width="504" height="347"
                            alt="banner" />
                        <div class="mark-deal"><i>%
                                Deal</i></div>
                    </div>
