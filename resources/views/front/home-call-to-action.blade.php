        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <h4 class="text-white text-uppercase">looking for help to
                    find your car audio</h4>
                <h2 class="text-white">Best Car Audio Parts in Nairobi </h2>
            ...
            <div class="col-lg-5 call-action">
                <div class="d-inline-flex align-items-center text-left divider">
                    ...
                    <h6 class="pt-1 line-height-1 text-uppercase text-white">Call us now<a href="tel:#{{$item->mobile}}"
                            class="d-block text-white ls-10 pt-2">{{$item->mobile}}</a></h6>
                </div>
                <a target="new" href="{{url('/')}}/find-us" class="btn btn-borders btn-rounded btn-outline-white ls-25">Send Us a
                    Message</a>
            </div>
        </div>
    </div>
