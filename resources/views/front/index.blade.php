        ...
        <div class="container">
            ...
            'responsive': {
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="demo42-product.html">
                            <img src="{{asset('theme/assets/images/demoes/demo42/product/product15-300x300.jpg')}}" width="300"
                                height="300" alt="product">
                        </a>
                        <div class="label-group">
                            <span class="product-label label-sale">-13%</span>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="demo42-product.html">
                            <img src="{{asset('theme/assets/images/demoes/demo42/product/product14-300x300.jpg')}}" width="300"
                                height="300" alt="product">
                        </a>
                        <div class="btn-icon-group">
                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
