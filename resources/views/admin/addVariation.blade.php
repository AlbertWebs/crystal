            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center><h2> Add Product variation For <strong>{{$Product->name}}</strong> </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Variation')}}" enctype="multipart/form-data">
                <input type="hidden" name="product_id" value="{{$Product->id}}">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Variation</button>
